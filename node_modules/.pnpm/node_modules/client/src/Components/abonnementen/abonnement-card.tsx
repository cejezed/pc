  ...
  return (
    <div className={`rounded-xl border bg-white p-4 hover:shadow-md transition-shadow ${
      ...
      <div className="flex flex-wrap gap-2 mb-3">
        <span
          className={`inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium border ${getCategoryColor(subscription.category || 'other')}`}
        >
          <span>{getCategoryIcon(subscription.category || 'other')}</span>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3 mb-1">
            ...
            {/* Category Badge */}
            <span
              className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-medium border ${getCategoryColor(subscription.category || 'other')}`}
            >
              <span>{getCategoryIcon(subscription.category || 'other')}</span>
              <span className="capitalize">{subscription.category || "other"}</span>
            </span>
